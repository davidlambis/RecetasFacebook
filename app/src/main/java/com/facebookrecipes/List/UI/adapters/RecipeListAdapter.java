...
public class RecipeListAdapter extends RecyclerView.Adapter<RecipeListAdapter.ViewHolder> {
    ...
    public RecipeListAdapter(List<Recipe> recipeList, ImageLoader imageLoader, IOnItemClickListener onItemClickListener) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setOnItemClickListener(final Recipe currentRecipe, final IOnItemClickListener onItemClickListener) {
